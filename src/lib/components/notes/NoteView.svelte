...
<a use:press={{ timeframe: 300, triggerBeforeFinished: false }} on:press={show} href="/notes/{note.id}" class="drag-none flex flex-col gap-2 p-4 rounded-lg shadow select-none border-[#2F2F2F] border bg-[#2F2F2F] bg-opacity-5 w-full h-44 active:opacity-60 transition ease-in-out duration-500">
